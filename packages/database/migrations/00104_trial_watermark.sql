-- Trial watermark on TV playback during active Solo trials.

create or replace function public.account_shows_trial_watermark(p_owner_id uuid)
returns boolean
language sql
stable
security definer
...
revoke all on function public.account_shows_trial_watermark(uuid) from public;
grant execute on function public.account_shows_trial_watermark(uuid) to authenticated;
