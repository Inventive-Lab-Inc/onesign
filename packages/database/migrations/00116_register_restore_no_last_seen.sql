-- Registration only identifies the player; liveness comes from tv_device_heartbeat /
-- tv_device_report_telemetry. Updating last_seen here made screens look reachable
-- after register_or_restore even when the player was not actively running.
