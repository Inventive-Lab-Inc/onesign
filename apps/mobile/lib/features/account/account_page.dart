  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return sessionAsync.when(
      ...
      data: (session) {
        ...
        final canAdmin = session.activeWorkspace.hasPermission('administrator') ||
        ...
        return ListView(
          ...
          children: [
                    ...
                    return ListTile(
                      ...
                      trailing: user.invitationPending && canAdmin
                          ? IconButton(
                              ...
                              onPressed: () async {
                                try {
                                  await ref.read(appApiClientProvider).resendInvite(
                                        email: user.email,
            ...
            ListTile(
              ...
              title: const Text('Billing & plan on web'),
              onTap: () => launchUrl(
                Uri.parse('${AppEnv.appUrl}/account'),
