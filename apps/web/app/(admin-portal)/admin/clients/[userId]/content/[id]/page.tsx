...
function AdminClientContentDetailPageContent() {
  ...
  return <MediaDetailWorkspace mediaId={item.id} ownerId={ownerId} readOnly={!canWrite} />;
}

export default function AdminClientContentDetailPage() {
  return (
    <Suspense
      fallback={
        <div className="space-y-4">
    ...
    >
      <AdminClientContentDetailPageContent />
    </Suspense>
  );
}
