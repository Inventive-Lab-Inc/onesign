...
export default function PlaylistsPage() {
  ...
  return (
    <div className="flex min-h-[min(360px,50vh)] flex-col items-center justify-center rounded-lg border border-dashed border-border bg-muted/20 px-6 py-16 text-center">
      ...
      <h1 className="text-xl font-semibold tracking-tight text-foreground">Content workspace</h1>
      <p className="mt-2 max-w-md text-sm leading-relaxed text-muted-foreground">
        Upload files in Library, build playlist loops, then assign them to screens.
      </p>
